function [S0_COS, S0_SIN, S1_RX, S2_RX] = signal( R, V, fi, EQ64, EQ256)
    ...
    Sn_phase1 = wgn(N,64,1)';        	% БШ фазовый на певой антенне
    Sn_phase2 = wgn(N,64,1)';        	% БШ фазовый на второй антенне
    Sn_amp1   = raylrnd(1,N,64)';       % Шум Рэлея на первой антенне  
    Sn_amp2   = raylrnd(1,N,64)';       % Шум Рэлея на первой антенне     
%     Sn_amp1   = wgn(N,64,1)';         % БШ амплитудный на певой антенне  
%     Sn_amp2   = wgn(N,64,1)';         % БШ амплитудный на второй антенне
...
%     Sn_amp2(1:64,1:N) = 0;              % БШ амплитудный на второй антенне
    ...
    for i = 1:EQ64
        ...
        % моделирование периода зондирующего сигнала
